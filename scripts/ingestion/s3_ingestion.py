# # Ingesting the data in the distributed file system using S3 By AMAZON WEB SERVICES
# import boto3

# # Instantiating an S3 client (specified profile & endpoint URL)
# s3_client = boto3.client('s3', endpoint_url='http://localhost:4566', aws_access_key_id='69', aws_secret_access_key='69', region_name='us-east-1')
